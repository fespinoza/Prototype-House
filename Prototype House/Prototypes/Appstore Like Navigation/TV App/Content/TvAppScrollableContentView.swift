//
//  TvAppScrollableContentView.swift
//  Prototype House
//
...
class TvAppScrollableContentView: UIView {
...
struct TvAppScrollableContentView_Previews: PreviewProvider {
    static let tvAppContainer: UIView = {
        let tvApp = TvAppScrollableContentView(withAutoLayout: true)
